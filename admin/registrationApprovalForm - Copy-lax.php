 ...
 while($row = mysql_fetch_array($donorResult))
  {
    ...
    <!-- Hidden fields required to update set password , send email-->
     ...
     <input type="hidden" name=<?php echo "".$donor['officialEmail']."".$row[$user['id']]; ?> value=<?php echo "".$row[$donor['officialEmail']]; ?> />
...
function updateStatus($userID,$status)
{
	...
	{ 
			...
			$displayName=$_POST[$dpname];
			 $mailName="".$donor['officialEmail']."".$userID;
