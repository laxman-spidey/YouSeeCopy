...
$donor['personalEmail']="personal_e_mail_id";
$donor['officialEmail']="official_e_mail_id";
...
$donorInsertAtts="".$donor['type'].",".$donor['fname'].",".$donor['lname'].",".$donor['dob'].",".$donor['gender'].",".$donor['address'].",".$donor['city'].",".$donor['state'].",".$donor['country'].",".$donor['pincode'].",".$donor['occupation'].",".$donor['designation'].",".$donor['phno'].",".$donor['personalEmail'].",".$donor['officialEmail'].",".$donor['preferredEmail'].",".$donor['pan'].",".$donor['featurePermission'].",".$donor['featureQuote'].",".$donor['displayName'].",".$donor['img'].",".$donor['orgName'].",".$donor['orgType'].",".$donor['orgDesc'].",".$donor['userID']."";
