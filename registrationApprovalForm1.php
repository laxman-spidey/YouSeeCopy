...
<div id="tabs" class="tab-box">
 ...
 <div id="donorDiv" style="display:block">
 
 <form id="approveRequests" name="approveRequests" method="post" action="adminHome.php">
 ...
 while($row = mysql_fetch_array($donorResult))
  ...
  <div align="center"><input   name="donorSubmit" type="submit" value="submit" /></div>
  </form>
 ...
 $ngoResult = mysql_query($query);
 ?>
 <div id="ngoDiv" style="display:none">
 <form id="approveRequests" name="approveRequests" method="post" action="adminHome.php">
 <input name="formname" type="hidden" value="actionDonor" />
 <table align="center" id="altColorTable" border="0">
 <tr class="alt">
 ...
 while($row = mysql_fetch_array($ngoResult))
  ...
  <div align="center"><input name="ngoSubmit" type="submit" value="submit" /></div>
  </form>
